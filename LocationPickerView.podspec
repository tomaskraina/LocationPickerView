Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/tomaskraina/LocationPickerView.git"
  s.screenshots  = "https://raw.github.com/tomaskraina/LocationPickerView/master/github-images/01.png"
  s.license      = { :type => 'MIT', :file => 'LICENSE' }
  s.author       = { "Christopher Constable" => "chris@futura.io" }
  s.source       = { :git => "https://github.com/tomaskraina/LocationPickerView.git", :tag => "1.1.2" }
